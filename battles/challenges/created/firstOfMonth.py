...
def generateTestCase(year, month):
    ...
    fom = date(year, month, 1)
    print("ans:", fom.weekday(), totals[fom.weekday()])
...
def generateTestCaseTot(year, month):
    ...
    fom = date(year, month, 1)
    print("ans:", totals[fom.weekday()])
    # print('minindex:', minindex(totals))
    # if minindex(totals) == fom.weekday():
    #     print("match")
    return totals[fom.weekday()]
    

    
def xlsFirstOfMonth(weekdayTotals):
...
def generateTestCases():
    ...
    for year in range(2015, 2021):
        for month in range(1, 13):
            ...
            anss.add(generateTestCaseTot(year, month))
