...
def test():
    print("stringReformatting tests")
    testeql(stringReformatting("2-4a0r7-4k", 4), "24a0-r74k")
    testeql(stringReformatting("-$!5G-R-", 4), "$-!5GR")
    testeql(stringReformatting("IBd#0-1-IL646-j$@8-2$-TBU", 17), "IBd-#01IL646j$@82$TBU")
