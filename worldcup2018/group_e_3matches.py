...
""")
    ...
    for result in results:
        ...
        winners = ""
        winners += match(serv_hypo, swi_hypo, result[0]) + ", "
        winners += match(serv_hypo, bra_hypo, result[1]) + ", "
        winners += match(swi_hypo, cos_hypo, result[2])
    ...
    print("'BRA in' in a total of", bra_in, "out of", 3**3, "scenarios")
